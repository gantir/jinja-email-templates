...
class SMTPDeliveryEngine(Engine):
    def __init__(
        ...
        warnings.warn(
            "SMTPDeliveryEngine is a new and not thoroughly tested feature of templatemail."
        )
    ...
    def _send_simple_message_start_tls(
        self,
        from_address: str,
        to_addresses: List[str],
        subject: str,
    ...
    def _send_simple_message_no_security(
        self,
        from_address: str,
        to_addresses: List[str],
        subject: str,
